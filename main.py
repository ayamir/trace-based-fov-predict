...
def train_loop(dataloader, loss_name, loss_fn, epochs, lr):
    ...
    model_dir = loss_name + "/models_e" + str(epochs) + "/"
...
def test_loop(dataloader, loss_name, loss_fn, epochs):
    ...
    model_dir = loss_name + "/models_e" + str(epochs) + "/" + str(epochs - 1)
    test_dir = loss_name + "/test_e" + str(epochs) + "/"
...
def clean():
    cmder.runCmd(f"mv ./models/ ./models_bak")
    cmder.runCmd(f"mv ./test/ ./test_bak")
